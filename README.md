...
-**terminal tab 1 & 2 & 3 ==>** used self-generate data inside the `db.json`, all data shown in `db.json` is fetched (GET) by jQuery AJAX from `api-url: http://localhost:3000/Tora` <br />
